...
| **Resend** | e-mail transacional, incluindo convite e alertas de lead | `lib/email/`, `lib/notifications/email.handler.ts` | opcional — convite cai em copy-to-clipboard e alertas são pulados com motivo |
